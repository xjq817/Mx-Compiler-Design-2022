...
define i32 @main() #0 {
main.entry:
	store i32 0, i32 %__tmp_24, align 4
	...
	store i32** %arr_ptr_11, i32** %__tmp_25, align 4
...
main.0_get_new_array_condition:
	store i32** %__tmp_25, i32** %__tmp_26, align 4
	%cmp_iter_end_15 = icmp ne i32** %__tmp_26, %end_ptr_13
...
main.0_get_new_array_loop:
	...
	store i32* %arr_ptr_21, i32** %__tmp_26, align 4
	%next_iter_ptr_22 = getelementptr inbounds i32*, i32** %__tmp_26, i32 1
	store i32** %next_iter_ptr_22, i32** %__tmp_25, align 4
	br label %main.0_get_new_array_condition
...
main.return:
	store i32 %__tmp_24, i32 %__tmp_27, align 4
	ret i32 %__tmp_27
