...
public class MxParser extends Parser {
	...
	public static class NewErrorExprContext extends NewTypeContext {
		public TerminalNode New() { return getToken(MxParser.New, 0); }
		public SingleTypeContext singleType() {
			return getRuleContext(SingleTypeContext.class,0);
		}
		...
		public NewErrorExprContext(NewTypeContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MxListener ) ((MxListener)listener).enterNewErrorExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MxListener ) ((MxListener)listener).exitNewErrorExpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MxVisitor ) return ((MxVisitor<? extends T>)visitor).visitNewErrorExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final NewTypeContext newType() throws RecognitionException {
		...
		try {
			...
			case 1:
				_localctx = new NewErrorExprContext(_localctx);
				enterOuterAlt(_localctx, 1);
				{
				setState(282);
				match(New);
