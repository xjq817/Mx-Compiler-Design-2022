...
public interface MxVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link MxParser#constructionDef}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConstructionDef(MxParser.ConstructionDefContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitNewObjExpr(MxParser.NewObjExprContext ctx);
	/**
